...
function ValideInputs(){
    ...
    /*const successIcon = formControl.querySelector('.icon-success');
    ...
    function setSuccessFor(input){
        ...
        /*const successIcon = formControl.querySelector('.icon-success');
        const errorIcon = formControl.querySelector('.icon-error');
        successIcon.style.visibility = 'visibility';
    ...
    /*function resetFormState() {
        // Restablecer las clases de estilo y ocultar los iconos de éxito y error
