...
{
    if(strlen($nombre) == 0 || strlen($apellido1) == 0 || strlen($apellido2) == 0 || strlen($email) == 0 || strlen($login) == 0 || strlen($password) == 0) {
...
if ($validacion !== "") {
    echo '<div class="mensaje">'. $validacion . '</div>';
    echo '<br><a href="index.php">Volver al registro</a>';
} else {
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<a href="index.php">Volver al registro</a>';
        ...
        if ($conn->query($sql) === TRUE) {
            echo '<div class="mensajeok">' . "<h2>Registro completado con éxito</h2>" . '</div>' ;
            echo '<br><a href="index.php">Volver al registro</a>';
